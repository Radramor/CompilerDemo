...
<body>
  ...
  <img src="Graph/compile.png" alt="Граф конечного автомата">
  <h3>Тестовые примеры:</h3>
  <ol>
    <li><h4>Тест 1: Пример ошибок</h4></li>
	  <img src="Graph/TestParser1.png" alt="Первый пример парсера">
    <li><h4>Тест 2: Все комментарии написаны правильно </h4></li>
	  <img src="Graph/TestParser2.png" alt="Второй пример парсера">
  </ol>
  ...
  <ol>
    ...
    <li><h4>Тест 2: Исправленный код </h4></li>
	  <img src="Graph/TestParser3.png" alt="Второй пример парсера">
  </ol>
</body>
</html>
